...
const EventCard: FC<EventCardProps> = ({
  ...
  //   const { title, checkin, type, active_date_time, description, id } = event;
  ...
  return (
    <>
      <div className="bg-white my-4 p-4 rounded-md flex justify-between items-center">
        <p className="">{title}</p>
        <p> Start Time: {moment(active_date_time).format("HH:MM a")}</p>
        <div className={`bg-gray-400 font-bold text-white p-4 rounded-md`}>
          <p>{statusText}</p>
        </div>
      </div>
